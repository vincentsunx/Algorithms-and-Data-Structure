...
info_t info;                        // structe info for storing printing information
...
int main(int argc, char *argv[100]) {
    ...
    /* ininitialise data in info_t structre */
    info.expanded = 0;
    info.generated = 0;
    info.max_depth = 0;
    info.total_time = 0.0;
...
void MainLoop() {
    ...
    do {
        ...
        if(ai_run){
            ...
            move_t selected_move = get_next_move( current_state, budget, propagation, ai_stats , &info );
